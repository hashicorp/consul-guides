...
bastion_consul_version  = "0.9.2-ent" # Consul version tag (e.g. 0.9.2 or 0.9.2-ent) - https://releases.hashicorp.com/consul/
bastion_vault_version   = "0.8.1-ent" # Vault version tag (e.g. 0.8.1 or 0.8.1-ent) - https://releases.hashicorp.com/vault/
bastion_nomad_version   = "0.6.2" # Nomad version tag (e.g. 0.6.2 or 0.6.2-ent) - https://releases.hashicorp.com/nomad/
bastion_os              = "Ubuntu" # OS (e.g. RHEL, Ubuntu)
bastion_os_version      = "16.04" # OS Version (e.g. 7.3 for RHEL, 16.04 for Ubuntu)
